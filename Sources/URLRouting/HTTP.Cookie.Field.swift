...
extension RFC_6265.Cookie.Field: Serializer.`Protocol`, Coder.`Protocol`, Parser_Primitive.Parser.Bidirectional where Value: Parser_Primitive.Parser.Bidirectional {
